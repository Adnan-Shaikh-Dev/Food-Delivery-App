  ...
  return (
    <div className="w-full bg-white shadow-sm">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
            ...
            <span className="absolute -top-2 -right-2 flex h-5 w-5 items-center justify-center rounded-full bg-[#e23744] text-sx font-semibold text-white">0</span>
            </Link>

            {
                isAuth? <Link to='/account' className="font-medium text-[#e23744]">Account</Link>:<Link to='/login' className="font-medium text-[#e23744]">Login</Link>
            }
        </div>
        </div>
        {/* Search */}
